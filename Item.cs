...
public class TurtleArmor : Item
{
		...
		Type = ItemType.Armor;
		modifiers.Add(Stats.Defense, 20)
		//other modifiers don't take effect until player turn
}
...
public class MrFriendly : Item
{
	public MrFriendly()
	{
		Name = "Mr. Friendly";
		Description = "10 damage, hits twice";
		Type = ItemType.Weapon;
		modifiers.Add(new StatModifier(Stats.Damage, 10));
		//code to hit twice
	}
}
...
public class PotionPayback : Item
{
		...
		modifiers.Add(Stats.Attack, damage);  
}
public class PotionCocaine : Item
{
		...
		Type = ItemType.Potion;
		modifiers.Add(Stats.Attack, attack);
}
